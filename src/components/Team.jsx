    ...
    <section className="bg-gray-400 py-20 mt-10">
      <div className="w-[70%] mx-auto">
        <div className="flex flex-col gap-3 justify-center items-center w-[50%] mx-auto text-center">
          <h2 className="text-5xl text-black font-semibold ">Our Team</h2>
          <p className="text-black text-lg">
            We are comprised of experienced with passion for travel and
            commitment to reader.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-10 py-20">
          {teamMenbers.map((member) => {
            return (
              <div className=" flex-col gap-4 justify-center items-center bg-gray-50 py-10 px-0">
                <div>
